...
import theNavi.patches.relics.BottledPlaceholderField;
import theNavi.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theNavi.NaviMod.logger;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = NaviMod.makeID("BottledPlaceholderRelic");
