...
public class CopyAnyAction extends AbstractGameAction {
    private static final UIStrings uiStrings;
    public static final String[] TEXT;
    private AbstractPlayer p;
    private static final float DURATION;

    public CopyAnyAction(AbstractCreature target, AbstractCreature source, int amount) {
    ...
    public void update() {
        if (this.duration == DURATION) {
            if (this.p.hand.isEmpty()) {
                ...
                this.addToBot(new MakeTempCardInHandAction(this.p.hand.getBottomCard(),this.amount));
                this.isDone = true;
            } else {
